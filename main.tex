...
\supervisor{Dr Christophe Eloy}      % your supervisor(s) name - no . in Dr
\cosupervisor{Dr Benjamin Favier}    % your cosupervisor(s) name - no . in Dr *OPTIONAL* 
									 % simply comment out the above line if absent
\department{IRPHE}   % your department (e.g. Artificial Intelligence)
\faculty{Centrale Méditerannée}       % your faculty (e.g. ICT)
\degreeName{PhD in Fluid Physics and Mechanics defended at Centrale Méditerranée}       % the degree you are reading
...
{\backmatter
	...
	{ 	\scriptsize\bibliography{
		...
		chap_end/surfing_larvae_biblio,
		article
	}}
	\printindex
}
