...
\nomenclature[B, 01]{\(\alpha\)}{Largest eigenvalue of $\GradientsSym$ or dimensionless surfing time horizon [Eq.~\eqref{eq:tau_adapt}]}
\nomenclature[B, 02]{\(\beta\)}{Intermediate (or smallest in 2D) eigenvalue of $\GradientsSym$ or bearing of vehicle}
\nomenclature[B, 03]{\(\gamma\)}{Smallest eigenvalue of $\GradientsSym$, shear value in a simple shear flow}
\nomenclature[B, 04]{\(\delta\)}{Defined as $\delta \equiv \alpha$}
...
\nomenclature[B, 08]{\(\theta\)}{Signed angle from $\Direction$ to $\SwimmingDirection$ or latitude}
...
\nomenclature[B, 11]{\(\lambda\)}{Taylor microscale [Eq.~\eqref{eq:taylor_microscale}] or length horizon in the local Dijkstra approach}
\nomenclature[B, 12]{\(\varLambda\)}{Final length to reach}
...
\nomenclature[B, 23]{\(\phi\)}{Longitude}
...
\nomenclature[C, 01]{\(d\)}{Plankter diameter}
...
\nomenclature[C, 05]{\(E\)}{Spectral energy density or set of graph edges}
\nomenclature[C, 06]{\(\mathcal{E}\)}{Total kinetic energy of the flow}
\nomenclature[C, 07]{\(\vec{f}_{\mathrm{ext.}}\)}{Resultant of external volumic forces on the fluid}
\nomenclature[C, 08]{\(\vec{F}_{\mathrm{flow}}\)}{Resultant of flow forces on the plankter}
...
\nomenclature[C, 13]{\(l\)}{Turbulent flow length scale that ranges from $\KolmogorovScale$ to $L$ or filter length [Eq.~\eqref{eq:filter_length}]}
...
\nomenclature[C, 18]{\(m\)}{Dimension of the problem: $m=2$ for 2D and $m=3$ for 3D}
\nomenclature[C, 19]{\(p\)}{Flow pressure or probability function}
...
\nomenclature[C, 34]{\(D\)}{Large scale flow length}
...
\nomenclature[E, 2]{\(\displaystyle \mathit{Re_{\lambda}}\)}{Taylor scale Reynolds number [Eq.~\eqref{eq:taylor_scale_reynolds}]}
\nomenclature[E, 3]{\(\displaystyle \mathit{Re_p}\)}{Particle Reynolds number [Eq.~\eqref{eq:particle_reynolds_number}]}
