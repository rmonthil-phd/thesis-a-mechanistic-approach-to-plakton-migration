\begin{tikzpicture}
	...
	\begin{groupplot}[
		...
		\nextgroupplot[
			...
			]{data/surfers_in_channel_flow_y/surfer__merge_average_velocity_axis_1.csv};
		...
		\nextgroupplot[
			...
			\addplot[name path=A, draw=none, forget plot, on layer=axis background] table [
				...
				restrict expr to domain={\thisrowno{3}}{0.04:0.06},
				unbounded coords=discard,
			]{data/adaptive_surfers_in_channel_flow_y/surfer__merge_average_velocity_axis_1.csv};
			\addplot[name path=B, draw=none, forget plot, on layer=axis background] table [
				x expr={\thisrowno{4}}, 
				y expr={(\thisrowno{1} + \thisrowno{2}) / \thisrowno{3}},
				col sep=comma, 
